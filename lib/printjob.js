...
Printjob.prototype = {
	...
	newLine: function (count) {
		...
		//var buf = new Buffer( cmds.CTL_CR );
		//var buf = new Buffer( cmds.CTL_FF );
		//var buf = new Buffer( cmds.CTL_VT );
		var buf = new Buffer([ 0x1b, 0x4a, 0xff ]);
	...
	setUnderline: function (underline) {
		...
		var cmd = underline ? TXT_UNDERL_ON : TXT_UNDERL_OFF;
		var buf = new Buffer(cmd);
		this._queue.push(buf);
